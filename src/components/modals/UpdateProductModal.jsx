                        ...
                        <div className="modal-body">
                            ...
                            <div onSubmit={onSubmit}>
                                <div className="form-group">
                                    <label>Name  </label>
                                    <input type="text" className="form-control form-field d-flex align-items-center" value={state.nameProduct} name="nameProduct" onChange={onChange} />
                                </div>
                                <div className="form-group">
                                    <label>Amount  </label>
                                ...
                                <div className="form-group" >
                                    ...
                                    <div className="row">
                                        <div className="col-md-10">
                                            <input type="file" className="form-control form-field align-items-center custom-file-input" accept="image/*" onChange={(e) => setImage(e.target.files[0])} />
                                        </div>
